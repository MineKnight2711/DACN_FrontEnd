...
import 'package:fooddelivery_fe/screens/login/rest_password_view.dart';
import 'package:fooddelivery_fe/screens/login/sing_up_view.dart';
import 'package:fooddelivery_fe/screens/on_boarding/on_boarding_view.dart';
import 'package:fooddelivery_fe/utils/custom/color_extension.dart';
import 'package:fooddelivery_fe/utils/custom/extension.dart';
...
class _LoginViewState extends State<LoginView> {
  ...
  void serviceCallLogin(Map<String, dynamic> parameter) {
    ...
    ServiceCall.post(parameter, SVKey.svLogin,
      ...
      Globs.hideHUD();
      if (responseObj[KKey.message] == "Success") {
